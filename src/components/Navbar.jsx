...
const Navbar = () => {
    ...
    return (
        <nav className='navbar flex flex-row justify-between items-center z-10'>
            <div>
                <Link to="/"><img src={logo} alt="Brand-logo" className='w-[125px] h-[22px] md:m-0 m-3'/> </Link>
            </div>
            ...
            <div className='md:hidden z-10 fixed top-0 right-0 p-5 rounded-bl-3xl bg-[#0000007c] backdrop-blur-[20px]'>
                {
